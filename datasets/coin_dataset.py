...
class CustomDataset(Dataset):
    def __init__(self, args, split):
        ...
        for video_id in data:
            if video_id in ['AfiVmAjfTNs', 'cjwtcDKTQM8','MGPvyywqhx8','vdUBmiIFaZg','moaD22jhXo0','ka3zig5hY9w','uDZa1YnEhvI']:
                continue
    ...
    def __getitem__(self, idx):
        video_features = np.load(f'/data_local3/susimmuk/Coin/features/{self.videos[idx]}.npy')
