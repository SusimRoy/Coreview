...
files = glob.glob(f'/data_local3/susimmuk/Coin/COIN_video/*/*/*.mp4')
...
for cnt, file in enumerate(tqdm(files)):
    ...
    if video_id in ['AfiVmAjfTNs', 'cjwtcDKTQM8','MGPvyywqhx8','vdUBmiIFaZg','moaD22jhXo0']:
        continue

    dest_mean = f'/data_local3/susimmuk/Coin/features/{video_id}.npy'
